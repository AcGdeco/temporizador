...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [136 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 5120, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 10752640; uint32_t buffer_offset
	}, ; 127: System.Threading.Thread
	%struct.CompressedAssemblyDescriptor {
		i32 12288, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 10757760; uint32_t buffer_offset
	}, ; 128: System.Threading
	%struct.CompressedAssemblyDescriptor {
		i32 5120, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 10770048; uint32_t buffer_offset
	}, ; 129: System.Xml.ReaderWriter
	%struct.CompressedAssemblyDescriptor {
		i32 5120, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 10775168; uint32_t buffer_offset
	}, ; 130: System
	%struct.CompressedAssemblyDescriptor {
		i32 9216, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 10780288; uint32_t buffer_offset
	}, ; 131: netstandard
	%struct.CompressedAssemblyDescriptor {
		i32 2014208, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 10789504; uint32_t buffer_offset
	}, ; 132: System.Private.CoreLib
	%struct.CompressedAssemblyDescriptor {
		i32 171008, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12803712; uint32_t buffer_offset
	}, ; 133: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12974720; uint32_t buffer_offset
	}, ; 134: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2123776, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12996256; uint32_t buffer_offset
	} ; 135: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15120032, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15120032 x i8] zeroinitializer, align 1
