...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [135 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12602496; uint32_t buffer_offset
	}, ; 132: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12773504; uint32_t buffer_offset
	}, ; 133: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2088960, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12795040; uint32_t buffer_offset
	} ; 134: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14884000, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14884000 x i8] zeroinitializer, align 1
