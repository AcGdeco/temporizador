...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [138 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 8441472; uint32_t buffer_offset
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 10631808; uint32_t buffer_offset
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12978304; uint32_t buffer_offset
	}, ; 135: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13149312; uint32_t buffer_offset
	}, ; 136: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2120704, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13170848; uint32_t buffer_offset
	} ; 137: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15291552, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15291552 x i8] zeroinitializer, align 1
