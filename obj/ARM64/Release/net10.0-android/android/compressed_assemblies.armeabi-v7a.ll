...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [136 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12749952; uint32_t buffer_offset
	}, ; 133: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12920960; uint32_t buffer_offset
	}, ; 134: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2126336, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12942496; uint32_t buffer_offset
	} ; 135: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15068832, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15068832 x i8] zeroinitializer, align 1
